...
export function SearchBar({ searchQuery, onSearchChange }: SearchBarProps) {
  ...
  return (
    <label className="flex w-full items-center gap-3 rounded-[12px] border border-[#1F2933] bg-[#111827] px-4 py-3 text-left shadow-[0_0_14px_rgba(20,165,255,0.18)] focus-within:border-[#14A5FF] focus-within:shadow-[0_0_16px_rgba(20,165,255,0.35)]">
      <svg
